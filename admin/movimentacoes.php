...
include '../conecta.php';
$pagina_atual = "movimentacoes.php";

mysqli_set_charset( $conn, 'utf8');
$pagina = (isset($_GET['pagina']))? $_GET['pagina'] : 1;

//Selecionar todos os logs da tabela
$result_log = "SELECT * from log_financeiro l WHERE l.id_movimentacao >7";
...
if(!isset($_POST["data1"]) && !isset($_POST["data2"] ) ){
          ...
          $result_logs = "SELECT nome_administrador,nome_cliente,nome_movimentacao,data,saldo_cliente,credito,debito,bonus FROM log_financeiro l INNER JOIN administrador a on l.id_administrador = a.id_administrador INNER JOIN tipo_movimentacao m on l.id_movimentacao = m.id_movimentacao INNER JOIN cliente c on l.id_cliente = c.id_cliente WHERE l.id_movimentacao >7 order by l.id_log desc limit $incio, $quantidade_pg ";
...
$data1 = $_POST["data1"];
$data2 = $_POST["data2"];
    $result_logs = "SELECT nome_administrador,nome_cliente,nome_movimentacao,data,credito,saldo_cliente,debito,bonus FROM log_financeiro l INNER JOIN administrador a on l.id_administrador = a.id_administrador INNER JOIN tipo_movimentacao m on l.id_movimentacao = m.id_movimentacao INNER JOIN cliente c on l.id_cliente = c.id_cliente where l.data >= '$data1' and l.data < DATE_ADD('$data2', INTERVAL 1 DAY) and l.id_movimentacao >7 order by l.id_log desc";
}
if(isset($_POST["termo"])){
       $pesquisa = $_POST["termo"];

       $result_logs = "SELECT nome_administrador,nome_cliente,nome_movimentacao,data,credito,debito,bonus FROM log_financeiro l INNER JOIN administrador a on l.id_administrador = a.id_administrador INNER JOIN tipo_movimentacao m on l.id_movimentacao = m.id_movimentacao INNER JOIN cliente c on l.id_cliente = c.id_cliente where c.nome_cliente LIKE '%".$pesquisa."%' and l.id_movimentacao >7 order by l.id_log desc";
...
<a href="dependentes.php"> <li class="list-group-item">Dependentes </li></a>
  <a href="movimentacoes.php"> <li class="<?php if($pagina_atual="movimentacoes.php"){echo "list-group-item active";} ?>">Registros financeiros </li></a>
...
<div class="accordion" id="accordionExample">
  <div class="card">
    ...
    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionExample">
      <div class="card-body">
                <form method="POST" action="movimentacoes.php" class="search nav-form">
...
<th> <?php echo date('d/m/Y', strtotime($row["data"])); ?> </th>
...
if(!isset($_POST["data1"]) && !isset($_POST["data2"] ) ){
          ...
          $result_logs = "SELECT sum(credito) as cr,sum(debito) as de,sum(bonus) as bo, 1 as num  FROM log_financeiro l INNER JOIN administrador a on l.id_administrador = a.id_administrador INNER JOIN tipo_movimentacao m on l.id_movimentacao = m.id_movimentacao INNER JOIN cliente c on l.id_cliente = c.id_cliente WHERE l.id_movimentacao >7 group by num";
...
$data1 = $_POST["data1"];
$data2 = $_POST["data2"];
    $result_logs = "SELECT sum(credito) as cr,sum(debito) as de,sum(bonus) as bo, 1 as num  FROM log_financeiro l INNER JOIN administrador a on l.id_administrador = a.id_administrador INNER JOIN tipo_movimentacao m on l.id_movimentacao = m.id_movimentacao INNER JOIN cliente c on l.id_cliente = c.id_cliente where l.data >= '$data1' and l.data < DATE_ADD('$data2', INTERVAL 1 DAY) and l.id_movimentacao >7 group by num";
}
if(isset($_POST["termo"])){
       $pesquisa = $_POST["termo"];

       $result_logs = "SELECT sum(credito) as cr,sum(debito) as de,sum(bonus) as bo, 1 as num FROM log_financeiro l INNER JOIN administrador a on l.id_administrador = a.id_administrador INNER JOIN tipo_movimentacao m on l.id_movimentacao = m.id_movimentacao INNER JOIN cliente c on l.id_cliente = c.id_cliente where c.nome_cliente LIKE '%".$pesquisa."%' and l.id_movimentacao >7 group by num";
...
$row = mysqli_fetch_assoc($resultado_logs);
     	...
     	?>
<td colspan="3">
Total depositado: <?php echo $row["cr"];?>



</td>
<td colspan="2">
Total de bônus concedido : <?php echo $row["bo"];?>



</td>
<td colspan="2">
Total vendido : <?php echo $row["de"];?>
...
<?php }
              ...
              <li><a href="movimentacoes.php?pagina=1"> Primeira página </a></li>
...
?>
                ...
                for($i = $pagina - $limitador; $i <= $pagina-1; $i++){
                  ...
                  if($i>=1){?>
                        ...
                        <li><a href="movimentacoes.php?pagina=<?php echo $i; ?>"> <?php echo $i;?></a></li>
...
if($pagina==$num_pagina){
       ...
       <li><a href="movimentacoes.php?pagina=<?php echo $num_pagina; ?>"> <span aria-hidden="true"> Ultima página </span></a></li>
...
<?php } ?>
    ...
    <a href = "relatorio_mov.php"><button type="button" class="btn btn-dark">Gerar relatório </button>
